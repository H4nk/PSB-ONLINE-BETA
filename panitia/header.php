...
<div id="menu">
	<ul class="group" id="menu_group_main">
		<li class="item first" id="one"><a href="utama.php" class="main current"><span class="outer"><span class="inner dashboard">Home</span></span></a></li>
        ...
        <li class="item middle" id="four"><a onclick='window.location="?hal=list"' href='#' class="main"><span class="outer"><span class="inner users">Pendaftar Siswa</span></span></a></li>
		...
		<li class="item middle" id="six"><a onclick='window.location="?hal=pengumuman"' href='#' class="main"><span class="outer"><span class="inner event_manager">Pengumuman</span></span></a></li>        
		<li class="item middle" id="seven"><a onclick='window.location="?hal=soal"' href='#' class="main"><span class="outer"><span class="inner newsletter">Soal</span></span></a></li>        
		<li class="item last" id="eight"><a onclick='window.location="?hal=log"' href='#' class="main"><span class="outer"><span class="inner settings">LOG</span></span></a></li>        
    </ul>
</div>
<!-- MENU END -->
</div>
