...
$s=mysql_query("select * from siswa where no_reg = '$get_no'");
$d=mysql_fetch_array($s);
$cek= $d['langkah']; 
$status = $d['status']; 
$_SESSION['waktumulai']=date("F j, Y, g:i a"); 
?>
<? if ($cek == 5 )
{
    ...
    mysql_query("update siswa set langkah='5' where no_reg='$get_no'");
    }; 
...
<script type="text/javascript" src="ujian/jquery-1.4.4.min.js"></script>
<script>
...
<p>
<img id="next" style="cursor:pointer" src="ujian/next.jpg">
<form action="ujian/nilaiakhir.php" method="post" id="formulir">
...
<?	
	...
	echo "ADA TIDAK DAPAT MENGIKUTI UJIAN ONLINE/ WAKTU UJIAN BELUM DI MULAI. HUBUNGI PANITIA PENERIMAAN PSB. Thanx ";
}
